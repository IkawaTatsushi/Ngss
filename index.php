...
<div class="card mb-5">
	<div class="card-body">
		<div class="d-flex">
			...
			<small class="text-muted mr-5 mt-5"><?php echo $post['created'];?></small>
		</div>
	...
	<?php if(isset($post['picture'])): ?>
		<img src="picture/<?php echo h($post['picture']);?>" class="img-fluid mt-4" alt="投稿画像">
	<?php endif; ?>
	<div class="d-flex justify-content-end">
		...
		<a href="post.php?id=<?php echo $post['id']; ?>" class="btn btn-dark mt-3 ml-3 mr-3 mb-3">返信</a>
		<?php if($post['user_id'] == $user_id): ?>
			<a href="delete.php?id=<?php echo $post['id']; ?>" class="btn btn-dark mt-3 mr-3 mb-3">削除</a>
		<?php endif;?>
	</div>
</div>
<?php endforeach; ?>
